'''
	sample program for BME280 sensor board. (python3 implementation)

	this is based on original program of Switch Science (bellow).
...
class BME280():
	...
	def readData(self):
		...
		_t1 = self.compensate_T(temp_raw)
		_t2 = self.compensate_P(pres_raw)
		_t3 = self.compensate_H(hum_raw)
		return {"temperature": _t1, "pressure" : _t2, "humidity" : _t3}
